...
class KidoChamkajonAdapter(private val booksList: ArrayList<KidoChamkajon>) : RecyclerView.Adapter<KidoChamkajonAdapter.VH>() {
    ...
    class VH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: KidoChamkajon, position: Int) {
