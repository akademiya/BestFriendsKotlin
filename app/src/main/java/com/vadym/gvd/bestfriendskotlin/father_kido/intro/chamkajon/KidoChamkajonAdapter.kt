...
class KidoChamkajonAdapter(private val booksList: ArrayList<KidoChamkajon>) : androidx.recyclerview.widget.RecyclerView.Adapter<KidoChamkajonAdapter.VH>() {
