...
class KidoChammanmulAdapter(private val booksList: ArrayList<KidoChammanmul>) : RecyclerView.Adapter<KidoChammanmulAdapter.VH>() {
    ...
    class VH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: KidoChammanmul, position: Int) {
