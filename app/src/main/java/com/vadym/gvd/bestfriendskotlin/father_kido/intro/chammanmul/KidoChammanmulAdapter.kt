...
class KidoChammanmulAdapter(private val booksList: ArrayList<KidoChammanmul>) : androidx.recyclerview.widget.RecyclerView.Adapter<KidoChammanmulAdapter.VH>() {
