...
class KidoUnificationAdapter(private val booksKido: ArrayList<KidoUnification>) : androidx.recyclerview.widget.RecyclerView.Adapter<KidoUnificationAdapter.VH>() {
