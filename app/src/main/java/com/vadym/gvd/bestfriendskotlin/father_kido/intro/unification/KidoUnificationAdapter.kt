...
class KidoUnificationAdapter(private val booksList: List<KidoUnification>) : RecyclerView.Adapter<KidoUnificationAdapter.VH>() {
    ...
    class VH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: KidoUnification, position: Int) {
