...
class KidoPenhwamesigiAdapter(private val booksList: ArrayList<KidoPenhwamesigi>) : androidx.recyclerview.widget.RecyclerView.Adapter<KidoPenhwamesigiAdapter.VH>() {
