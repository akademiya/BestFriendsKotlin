...
class KidoZelaniyaAdapter(
    private val booksList: List<KidoZelaniya>
) : RecyclerView.Adapter<KidoZelaniyaAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        holder.bind(booksList[position], position)
    }
    ...
    class VH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: KidoZelaniya, position: Int) {
