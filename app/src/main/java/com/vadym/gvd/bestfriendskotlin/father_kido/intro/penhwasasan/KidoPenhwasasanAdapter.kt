...
class KidoPenhwasasanAdapter(private val booksList: ArrayList<KidoPenhwasasan>) : RecyclerView.Adapter<KidoPenhwasasanAdapter.VH>() {
    ...
    class VH(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: KidoPenhwasasan, position: Int) {
