...
class KidoPenhwasasanAdapter(private val booksList: ArrayList<KidoPenhwasasan>) : androidx.recyclerview.widget.RecyclerView.Adapter<KidoPenhwasasanAdapter.VH>() {
    ...
    class VH(view: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view) {
        fun bind(books: KidoPenhwasasan) {
            itemView.let {
